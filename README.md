...
## About the project
A scientific calculator done using Tkinter module for UI
The design of UI and required button and their corresponding listeners for the buttons was constructed by @darkracer3010
...
(calculate function is used to separate and differentiate operators and operands)
